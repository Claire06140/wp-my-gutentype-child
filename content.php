...
/*
Modif +/- ligne 65 -> h3 avant modif en h1 pour balise title pour clean structure posts - 02 05 21
*/
...
if ( ( ! gutentype_sc_layouts_showed( 'title' ) || ! gutentype_sc_layouts_showed( 'postmeta' ) ) && ! in_array( get_post_format(), array( 'link', 'aside', 'status', 'quote' ) ) ) {
	...
	?>
		...
		if ( ! gutentype_sc_layouts_showed( 'title' ) ) {
			the_title( '<h1 class="post_title entry-title"' . ( $gutentype_seo ? ' itemprop="headline"' : '' ) . '>', '</h1>' );
		}
		// Post meta
